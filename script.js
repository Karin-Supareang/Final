...
const data = {
    ...
    person2: [
        "ปี 1\nโฟกัสกับพื้นฐานในการเรียนโดยเข้าใจเนื้อหาเรียนให้ได้มากที่สุด อย่างการพัฒนาเว็บไซต์ การแก้ปัญหาและการเขียนโปรแกรม และเก็บวิชาศึกษาทั่วไปพร้อมทั้งสอบ exempt ในปี 1 เพื่อประหยัดเวลาและเตรียมพร้อมสำหรับปี 2",
    ...
    person4: [
        "ปี 1\nเรียนตามไกด์ไลน์ของหลักสูตรที่ทางสาขาได้แนะนำมา และ ฝึกทักษะบางส่วนจากแหล่งเรียนรู้อื่นๆ",
        "ปี 2\nศึกษาและเน้นไปในด้านที่ตนเองสนใจ และ พยายามทำเกรดไปให้มากๆ",
